...
## Table of Contents:
- [Project Tasks](https://github.com/ThuyTran102/4__Sentiment_Analysis_on_movie_reviews?tab=readme-ov-file#project-task)
- [Datasource](https://github.com/ThuyTran102/4__Sentiment_Analysis_on_movie_reviews?tab=readme-ov-file#datasource)
- [Pre-trained Model](https://github.com/ThuyTran102/4__Sentiment_Analysis_on_movie_reviews?tab=readme-ov-file#pre-trained-model)
- [Performance Metrics](https://github.com/ThuyTran102/4__Sentiment_Analysis_on_movie_reviews?tab=readme-ov-file#performance-metrics)
- [Key Hyperparameters and their importance](https://github.com/ThuyTran102/4__Sentiment_Analysis_on_movie_reviews?tab=readme-ov-file#key-hyperparameters-and-their-importance)
- [Deployment Links](https://github.com/ThuyTran102/4__Sentiment_Analysis_on_movie_reviews?tab=readme-ov-file#deployment-links)
...
- **Accuracy: 98%**
<p align="center" style="margin-top: 20px; margin-bottom: 20px;">
<img width="45%" src="https://github.com/ThuyTran102/4__Sentiment_Analysis_on_movie_reviews/blob/main/images/result.png" alt="Outcome"></img>
</p>
...
| ----------- |
|![model](https://github.com/ThuyTran102/4__Sentiment_Analysis_on_movie_reviews/blob/main/images/model_on_huggingface.png)|


### Inference Example 1:
<p align="center" style="margin-top: 20px; margin-bottom: 20px;">
<img width="50%" src="https://github.com/ThuyTran102/4__Sentiment_Analysis_on_movie_reviews/blob/main/images/test1.png" alt="test1"></img>
</p>

### Inference Example 2:
<p align="center" style="margin-top: 20px; margin-bottom: 20px;">
<img width="50%" src="https://github.com/ThuyTran102/4__Sentiment_Analysis_on_movie_reviews/blob/main/images/test2.png" alt="test2"></img>
</p>
